                                                                                  ...
                                                                                  export default async function PrivacyPage() {
                                                                                    const policy = await getPrivacyPolicy();
                                                                                        ...
                                                                                        if (!policy) {
                                                                                            return (
                                                                                                  <main
                                                                                                          className="mx-auto flex min-h-screen w-full max-w-3xl flex-col items-center justify-center px-6 pb-20 pt-36 text-center"
                                                                                                                  role="alert"
                                                                                                                        >
                                                                                                                                                          ...
                                                                                                                                                          <h1 className="mt-3 text-3xl font-bold tracking-tight md:text-5xl">
                                                                                                                                                                    Privacy Policy unavailable
                                                                                                                                                                                    ...
                                                                                                                                                                                    <p className="mt-4 text-sm leading-7 text-muted-foreground">
                                                                                                                                                                                              Please try again later. The policy content could not be loaded.
                                                                                                                                                                                                      </p>
                                                                                                                                                                                                            </main>
                                                                                                                                                                                                                );
                                                                                                                                                                                                                  }
                                                                                                                                                                                                                                                                        ...
                                                                                                                                                                                                                                                                        <p className="mt-4 text-sm text-muted-foreground">
                                                                                                                                                                                                                                                                                Last updated: {policy.lastUpdated}
                                                                                                                                                                                                                                                                                            ...
                                                                                                                                                                                                                                                                                            {policy.sections.length === 0 ? (
                                                                                                                                                                                                                                                                                                    <p className="mt-10 rounded-2xl border border-foreground/10 bg-card/70 px-6 py-10 text-center text-sm text-muted-foreground">
